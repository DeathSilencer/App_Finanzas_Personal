...
export default function GeneralCajitaTurbo({
  ...
  const porcOcio = porciones.ocio || { presupuesto: 1500, gasto_real: ocio.gasto_real || 0, monto: ocio.remanente || 1500, pct: 38.0 };
  const porcEmg = porciones.emergencia || { presupuesto: 500, gasto_real: 0, monto: emg.aportado || 500, pct: 12.7 };
  const porcMoto = porciones.moto_80 || { presupuesto: 1355.2, gasto_real: 0, monto: 1355.2, pct: 34.4 };
  const porcSalidas = porciones.salidas_20 || { presupuesto: 338.8, gasto_real: 0, monto: 338.8, pct: 8.6 };
  ...
  // Totales presupuestados y gastados en los 6 fondos de Cajita Nu (sin Cetes ni Afore)
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-purple-950/70 via-slate-900/90 to-slate-950 border border-purple-500/40 relative overflow-hidden shadow-2xl">
        ...
        <div className="mt-6 pt-6 border-t border-purple-500/20 space-y-2.5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between text-xs font-semibold text-slate-300 gap-1">
            <span>Distribución de los 6 Fondos en tu Cajita Turbo (Descontados Cetes y AFORE):</span>
          ...
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div>
              ...
              <h3 className="text-base font-bold text-white mt-1 flex items-center space-x-2">
                ...
                <span>Saldo Acumulado tras Gastos Reales</span>
              </h3>
            </div>
            <div className="text-right">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs sm:text-sm">
            ...
            <tbody className="divide-y divide-slate-800 text-xs">
              ...
              {/* Moto 80% */}
              <tr className="hover:bg-slate-800/40 transition">
                <td className="p-3.5 font-bold text-white">🏍️ Acelerador Moto (80%)</td>
